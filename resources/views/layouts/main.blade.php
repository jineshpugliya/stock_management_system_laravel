  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <span class="dropdown-item dropdown-header">Anuta Notifications</span>
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
            <i class="fas fa-envelope mr-2"></i>Anuta new messages
            <span class="float-right text-muted text-sm">3 mins</span>
          </a>
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
            <i class="fas fa-users mr-2"></i> 80k friend requests
            <span class="float-right text-muted text-sm">12 hours</span>
          </a>
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
            <i class="fas fa-file mr-2"></i> FIR new reports
            <span class="float-right text-muted text-sm">2(To)day</span>
          </a>
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item dropdown-footer">Sigla Notifications</a>
        </div>
      </li>
      <li class="nav-item">
...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="../../dist/img/jin.jpg" alt="Thobda is not coing yet!!" class="brand-image img-circle elevation-3"
           style="opacity: .8">
            ...
            <ul class="nav nav-treeview" style="display: block;">
              ...
              <li class="nav-item">
                <a href="/subcategory/create" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>To Add a Sub category</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/product/create" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>To Add a Products</p>
                </a>
              </li>
            </ul>
          </li>
